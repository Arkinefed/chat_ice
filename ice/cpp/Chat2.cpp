...
const ::std::string iceC_Chat_RoomFactory_getName_name = "getName";
...
/// \cond INTERNAL
bool
Chat::RoomFactory::_iceD_getName(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    ::std::string ret = this->getName(current);
...
/// \cond INTERNAL
void
Chat::RoomFactoryPrx::_iceI_getName(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>& outAsync, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_Chat_RoomFactory_getName_name);
    outAsync->invoke(iceC_Chat_RoomFactory_getName_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::Chat::RoomFactory::_iceI_begin_getName(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Chat_RoomFactory_getName_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Chat_RoomFactory_getName_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Chat_RoomFactory_getName_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_Chat_RoomFactory_getName_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
::std::string
IceProxy::Chat::RoomFactory::end_getName(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Chat_RoomFactory_getName_name);
    ::std::string ret;
    if(!result->_waitForResponse())
    {
        try

...
public:
    ...
    ::std::string getName(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::std::string>(true, this, &RoomFactoryPrx::_iceI_getName, context).get();
    }
    ...
    auto getNameAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::std::string>>().get_future())
    {
        return _makePromiseOutgoing<::std::string, P>(false, this, &RoomFactoryPrx::_iceI_getName, context);
    }
    ...
    getNameAsync(::std::function<void(::std::string)> response,
                 ...
                 const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::string>(std::move(response), std::move(ex), std::move(sent), this, &Chat::RoomFactoryPrx::_iceI_getName, context);
    }
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Chat::RoomFactory::begin_getName.
 * Create a wrapper instance by calling ::Chat::newCallback_RoomFactory_getName.
 */
class Callback_RoomFactory_getName_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_RoomFactory_getName_Base> Callback_RoomFactory_getNamePtr;
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getName(const ::Chat::Callback_RoomFactory_getNamePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getName(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getName(const ::Ice::Context& context, const ::Chat::Callback_RoomFactory_getNamePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getName(context, cb, cookie);
    }
 ...
 */
template<class T>
class CallbackNC_RoomFactory_getName : public Callback_RoomFactory_getName_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_RoomFactory_getName(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Chat::RoomFactory::begin_getName.
 */
template<class T> Callback_RoomFactory_getNamePtr
newCallback_RoomFactory_getName(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_RoomFactory_getName<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_RoomFactory_getNamePtr
newCallback_RoomFactory_getName(T* instance, void (T::*cb)(const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_RoomFactory_getName<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_RoomFactory_getName : public Callback_RoomFactory_getName_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_RoomFactory_getName(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Chat::RoomFactory::begin_getName.
 */
template<class T, typename CT> Callback_RoomFactory_getNamePtr
newCallback_RoomFactory_getName(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_RoomFactory_getName<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_RoomFactory_getNamePtr
newCallback_RoomFactory_getName(T* instance, void (T::*cb)(const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_RoomFactory_getName<T, CT>(instance, cb, excb, sentcb);
}
